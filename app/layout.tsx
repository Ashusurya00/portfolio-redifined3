...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body>
        <ThemeProvider attribute="class" defaultTheme="dark" themes={["light", "dark", "calm"]} enableSystem={false} storageKey="as-theme">
          <div className="relative min-h-screen bg-bgMain dark:bg-bgMain text-textMain dark:text-textMain transition-colors duration-300 grid-bg">
            <Navbar />
